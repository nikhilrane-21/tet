...
from pyImgToText import pytesseract
...
pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe' # to make tesseract work, put in the exact path of tesseract
